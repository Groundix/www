    ...
    return (<div className={styles.chatContainer}>
        ...
        <div className={styles.chatBox}>
            ...
            <div className={styles.footerChat}>
                <textarea className={styles.writeMessage} name="Что  нового?" placeholder="Напиши что-нибудь..." cols="30" rows="10"
                    onChange={onMessageChange} ref={newMessage} value={props.newMessageText}></textarea>
                <button className={styles.sendButton} onClick={sendMessage}><i aria-hidden="true"><svg width="24"
                    height="24"
                    viewBox="0 0 24 24"
                    fill="none"
